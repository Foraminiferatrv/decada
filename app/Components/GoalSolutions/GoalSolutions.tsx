...
export const GoalSolutions = () => {
  ...
  return (
    <section className={S.GoalSolutions}>
      <div className={S.GoalSolutionsHeader}>
        <SettingsButton
          onClick={() => {
      ...
      <Reorder.Group
        className={S.GoalSolutionsContent}
        axis='y'
      ...
      <Fab className={S.AddButton} size='medium' onClick={addSolution}>
        <AddRoundedIcon />
      </Fab>
    </section>
  )
